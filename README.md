...
- 09/2022-11/2022 *In progress* Automation testing using Python(Selenium, Selene(API for Selenium), CI/CD, Pipelines, Requests, Rest API, Pytest, Github, Jenkins, Allure Report, Allure TestOps, Selenoid , Messenger reports(relegram/slack))
